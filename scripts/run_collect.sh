...
OUTPUT_DIR="outputs/datasets/teacher_cam/debug"                      # --out：数据输出目录
...
CHECKPOINT_PATH="logs/rsl_rl/unitree_go2_parkour/2026-01-28_22-35-55_try2/model_74000.pt"  # --checkpoint：本地 checkpoint 路径
