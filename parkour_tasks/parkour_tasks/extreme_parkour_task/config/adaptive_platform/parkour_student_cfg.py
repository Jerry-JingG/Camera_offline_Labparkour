...
from .parkour_teacher_cfg import AdaptivePlatformTeacherSceneCfg
@configclass
class AdaptivePlatformStudentSceneCfg(AdaptivePlatformTeacherSceneCfg):
...
@configclass
class UnitreeGo2StudentAdaptivePlatformEnvCfg(ParkourManagerBasedRLEnvCfg):
    scene: AdaptivePlatformStudentSceneCfg = AdaptivePlatformStudentSceneCfg(num_envs=192, env_spacing=1.)
    # Basic settings
...
@configclass
class UnitreeGo2StudentAdaptivePlatformEnvCfg_EVAL(UnitreeGo2StudentAdaptivePlatformEnvCfg):
    viewer = VIEWER 
...
@configclass
class UnitreeGo2StudentAdaptivePlatformEnvCfg_PLAY(UnitreeGo2StudentAdaptivePlatformEnvCfg_EVAL):
