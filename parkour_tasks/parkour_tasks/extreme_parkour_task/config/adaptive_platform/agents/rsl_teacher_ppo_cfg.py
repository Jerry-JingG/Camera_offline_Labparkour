...
@configclass
class UnitreeGo2AdaptivePlatformTeacherPPORunnerCfg(ParkourRslRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 50000
    save_interval = 100
    experiment_name = "unitree_go2_adaptive_platform_teacher"
