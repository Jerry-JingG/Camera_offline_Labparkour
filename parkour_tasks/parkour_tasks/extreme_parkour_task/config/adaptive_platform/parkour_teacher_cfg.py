...
@configclass
class AdaptivePlatformTeacherSceneCfg(ParkourDefaultSceneCfg):
...
@configclass
class UnitreeGo2TeacherAdaptivePlatformEnvCfg(ParkourManagerBasedRLEnvCfg):
    scene: AdaptivePlatformTeacherSceneCfg = AdaptivePlatformTeacherSceneCfg(num_envs=6144, env_spacing=1.)
    # Basic settings
...
@configclass
class UnitreeGo2TeacherAdaptivePlatformEnvCfg_EVAL(UnitreeGo2TeacherAdaptivePlatformEnvCfg):
    viewer = VIEWER 
...
@configclass
class UnitreeGo2TeacherAdaptivePlatformEnvCfg_PLAY(UnitreeGo2TeacherAdaptivePlatformEnvCfg_EVAL):
    viewer = VIEWER 
